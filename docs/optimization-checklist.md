...
- [x] 新增 `pnpm ops:manual-test:handoff` 中文 Markdown 交接报告：汇总真机验收状态、DevTools 打开目录、手工验收分组、视觉截图诊断、`visualQaNext` 下一台设备和截图保存路径、下一条截图命令、可复制命令和发布阻断项，方便发给协作者继续测试且不打开微信开发者工具。
